...
np.savetxt('tempdata/image_psf.txt', psf_image_data, delimiter = ' ')
...
for i in range(100):
    ...
    filename2 = "tempdata/PSFmodel_" + str(i + 1) + ".txt"
    temp_arr = np.load(filename)
    np.savetxt(filename2, temp_arr)
    array_of_PSFs.append(temp_arr)
...
x =int(outputs[0][1][0])
y = int(outputs[0][1][1])
prim_coords.append((x - 1, y - 1))
prim_coords.append((x - 1, y + 0))
prim_coords.append((x - 1, y + 1))
prim_coords.append((x + 0, y - 1))
prim_coords.append((x + 0, y + 0))
prim_coords.append((x + 0, y + 1))
prim_coords.append((x + 1, y - 1))
prim_coords.append((x + 1, y + 0))
prim_coords.append((x + 1, y + 1))
...
y = int(outputs[0][2][1])
x = int(outputs[0][2][0])
sec_coords.append((x - 1, y - 1))
sec_coords.append((x - 1, y + 0))
sec_coords.append((x - 1, y + 1))
sec_coords.append((x + 0, y - 1))
sec_coords.append((x + 0, y + 0))
sec_coords.append((x + 0, y + 1))
sec_coords.append((x + 1, y - 1))
sec_coords.append((x + 1, y + 0))
sec_coords.append((x + 1, y + 1))
...
prim_coords = np.asarray(prim_coords, dtype = '<f8')
...
np.savetxt('tempdata/residual_error_array.txt', residual_error_array)
np.savetxt('tempdata/center_array.txt',center_array)
np.savetxt('tempdata/secondary_array.txt',secondary_array)
np.savetxt('tempdata/best_primary_array.txt',best_primary_array)
np.savetxt('tempdata/flux_primary_array.txt',flux_primary_array)
np.savetxt('tempdata/best_secondary_array.txt',best_secondary_array)
np.savetxt('tempdata/flux_secondary_array.txt',flux_secondary_array)
np.savetxt('tempdata/flux_sum_array.txt',flux_sum_array)

print('starting Secondary Binary Fitting')
os.system('./Secondary_Binary_Fitting')
print('Secondary Fit done')

residual_error_array = np.loadtxt('tempdata/residual_error_array.txt')
center_array = np.loadtxt('tempdata/center_array.txt')
secondary_array = np.loadtxt('tempdata/secondary_array.txt')
best_primary_array = np.loadtxt('tempdata/best_primary_array.txt')
flux_primary_array = np.loadtxt('tempdata/flux_primary_array.txt')
best_secondary_array = np.loadtxt('tempdata/best_secondary_array.txt')
flux_secondary_array = np.loadtxt('tempdata/flux_secondary_array.txt')
flux_sum_array = np.loadtxt('tempdata/flux_sum_array.txt')
